    ...
    return (
        <div>
            ...
            <div className="mb-8 tracking-wider">
                ...
                <NavLink to='/redux' className={({ isActive }) => (`block text-gray-400 ${isActive ? 'bg-blue-500 text-gray-200' : ''} hover:text-gray-200 py-2 px-3 text-md my-2 mx-2 rounded-xl`)} >Redux</NavLink>
            </div>
        </div>
    );
}
